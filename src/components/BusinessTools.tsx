...
import { CreditCard, CheckCircle, AlertTriangle, Send, FileText, Settings, Clock, Loader2 } from 'lucide-react';
import { CoachSettings, TraineeSummary } from '../types';
import { sendEmailNotification, fetchCoachTrainees } from '../services/userData';
    ...
    <div className="space-y-8 animate-fade-in pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-xl p-6">
                ...
                {loading ? (
                    <div className="text-center py-8"><Loader2 className="animate-spin text-emerald-500 mx-auto"/></div>
